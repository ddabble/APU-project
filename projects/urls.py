...
urlpatterns = [
    ...
    path('new/', login_required(views.ProjectCreateView.as_view()), name='new_project'),
    ...
    path('<int:project_id>/tasks/<int:task_id>/', login_required(views.TaskView.as_view()), name='task_view'),
